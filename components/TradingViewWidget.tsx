...
const TradingViewWidget = ({ tittle, scriptUrl, config, height =600, className }: TradingViewWidgetProps)=> {
    const containerRef = useTradingViewWidget(scriptUrl, config, height);

    return (
        <div className="w-full">
            {tittle && <h3 className="font-semibold text-2xl text-gray-100 mb-5">{tittle}</h3> }
